...
(* Takes too long*) 
val isPresentOnDevice_: d: device -> pMechanism: _CK_MECHANISM_TYPE -> 
...
val deviceRemoveSession: #ks: seq key -> #ms: seq mechanismSpecification ->  hSession : _CK_SESSION_HANDLE -> 
